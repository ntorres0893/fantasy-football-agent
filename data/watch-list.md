...
> Team abbreviation follows every player name. *Last updated: 2026-08-24.*
> Full context in `data/player-notes.md`.

---

## 🏈 QB — wait; never draft before Round 6 (1-QB league)
- **High, only at value (R5–6):** Josh Allen (BUF), Lamar Jackson (BAL)
- **Sweet spot (R6–9):** Jayden Daniels (WAS), Jalen Hurts (PHI), Joe Burrow (CIN), Drake Maye (NE)
- **Late / stream (R10+):** Bo Nix (DEN), Caleb Williams (CHI), Dak Prescott (DAL), Patrick Mahomes (KC), Kyler Murray (MIN)
- **Flags:**
    - ✅ Mahomes (KC) — fully cleared (ACL), taking all first-team reps
    - ⚠️ Kyler Murray (MIN) — only startable if he wins the Minnesota job (vs McCarthy)
...
- **Flags:**
    ...
    - ⚠️ Breece Hall (NYJ) — groin, out 2–3 weeks, but praised for passing-down work → don't overreact, solid RB2 ceiling once healthy
...
- **Rounds 7+ (flex / upside):** Jaylen Waddle (DEN), Terry McLaurin (WAS), Zay Flowers (BAL), Rome Odunze (CHI), Deebo Samuel (SF), Stefon Diggs (WAS), Emeka Egbuka (TB), De'Zhaun Stribling (SF), Matthew Golden (GB), Alec Pierce (IND)
...
- **Flags:**
    ...
    - 💎 Deebo Samuel (SF) — PPR flex going cheap (SF WR room reshuffle)
    - 💎 Stefon Diggs (WAS) — ~WR49 value as a Jayden Daniels target
    - ❌ Ricky Pearsall (SF) & Jayden Higgins (HOU) — out for 2026 (off the board)

## 🎯 TE — pay up for the top 2, or wait and stream; avoid the middle
- **High (Rounds 2–3):** Brock Bowers (LV), Trey McBride (ARI)
- **Value target (R7–9):** Tucker Kraft (GB)
- **Mid (only if you missed the top 2):** Sam LaPorta (DET), Tyler Warren (IND)
