# 📊 Draft Guide by Position — 10-Team FULL PPR · Draft Sept 3
...
## 🏈 QB — wait; never draft before Round 6 (1-QB league)
- **High, only at value (R5–6):** Josh Allen, Lamar Jackson
- **Sweet spot (R6–9):** Jayden Daniels, Jalen Hurts, Joe Burrow, Drake Maye
- **Late / stream (R10+):** Bo Nix, Caleb Williams, Dak Prescott, Patrick Mahomes, Kyler Murray
- **Flags:**
    - ✅ Mahomes — fully cleared (ACL), taking all first-team reps
    - ⚠️ Kyler Murray — only startable if he wins the Minnesota job (vs McCarthy)
...
- **Flags:**
    ...
    - 🟢 Jonathon Brooks — Hubbard hurt → lead-back path opening (late sleeper)
    - 🟢 Bucky Irving — healthy post-shoulder → solid RB2
...
- **Flags:**
    ...
    - 🟢 Nico Collins — Jayden Higgins out for year → WR1 target share up
    - 💎 Deebo Samuel — PPR flex going cheap (SF WR room reshuffle)
    - 💎 Stefon Diggs — ~WR49 value as a Jayden Daniels target
    - ❌ Ricky Pearsall & Jayden Higgins — out for 2026 (off the board)

## 🎯 TE — pay up for the top 2, or wait and stream; avoid the middle
- **High (Rounds 2–3):** Brock Bowers, Trey McBride
- **Value target (R7–9):** Tucker Kraft
- **Mid (only if you missed the top 2):** Sam LaPorta, Tyler Warren
- **Late / stream (R11+):** Colston Loveland, Harold Fannin Jr., Dalton Kincaid, Isaiah Likely, Hunter Henry
- **Flags:**
    - 💎 Tucker Kraft — top-3 TE upside at a discount if the ACL's fully behind him
    - ⚠️ George Kittle — on PUP (Achilles), Week 1 not guaranteed → don't pay up

## 🛡️ D/ST — last two rounds only; stream weekly
- Don't draft before ~Round 13. Scoring rewards facing **weak offenses** (points and
  yards allowed), so stream a soft Week-1 matchup over "the best defense."

## 🦵 K — final pick; stream
- Distance-based FG scoring rewards **big legs** (50–59 = 5 pts, 60+ = 6). Lean a
  strong-legged kicker in a good offense — but never before your last pick.

---

## ⚔️ Position battles still shaking out
| Team | Battle | Lean / watch |
|------|--------|--------------|
| ARI RB | Allgeier / Love / Conner | committee; Love hurt (high ankle) |
| CHI RB | Swift lead (Monangai out) | Swift |
| NE RB | Stevenson / Henderson | Henderson upside |
| MIN QB | Murray vs McCarthy | Jefferson elite either way |
| WAS WR | McLaurin + Diggs | McLaurin alpha; Diggs value |
| DEN | Waddle WR1 / Dobbins RB1 | Waddle & Dobbins up; Sutton/Harvey down |

> **Flag legend:** ✅ cleared/buy · ⚠️ injury or role risk · 🔻 falling · 🟢 rising ·
> 💎 value (going later than worth) · ❌ out for the year.
